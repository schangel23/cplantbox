 ...
 *
 */
void LeafRandomParameter::createGeometry() {
    if (parametrisationType==0) {
        ...
        std::cout << "LeafRandomParameter::createGeometry(): Warning! unknown parametrisation type, could not create leaf geometry \n";
    }
}
