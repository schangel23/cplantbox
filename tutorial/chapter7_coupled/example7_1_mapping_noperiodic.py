...
s.initialize()
periodic = False  # MODIFIED: Disable periodic boundaries to avoid GCC 15 bug
...
# Interactive VTK window - press 's' to save screenshot, 'q' to quit
renWin = vp.render_window([mesh_actor[0], root_actor], "Test mapping", root_cbar, grid.GetBounds())
print("\n" + "="*60)
print("VTK WINDOW CONTROLS:")
print("  's' = Save screenshot to current directory as plot_plant.jpg")
print("  'q' = Quit window")
